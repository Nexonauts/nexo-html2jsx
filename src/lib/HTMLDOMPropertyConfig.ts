...
interface nodeType extends Element {
  removeAttribute: (arg0: string) => any;
  type: string; hasAttribute: (arg0: string) => boolean;
  setAttribute: (arg0: string, arg1: string) => void; validity: { badInput: any; };
}
...
interface HTMLDOMPropertyConfig {
  ...
  DOMMutationMethods: Record<string, (node: nodeType, value: any) => void>;
}
...
const HTMLDOMPropertyConfig: HTMLDOMPropertyConfig = {
  ...
  DOMPropertyNames: {},
  DOMMutationMethods: {
    value: function (node: nodeType, value: string | null) {
      if (value == null) {
